...
class _InvestorDetailsModalState extends State<InvestorDetailsModal>
  ...
  Widget build(BuildContext context) {
    ...
    final maxHeight = isTablet ? screenHeight * 0.85 : screenHeight * 0.95;
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: Row(
            children: [
              // Lewa kolumna - informacje podstawowe (30%)
              Expanded(
                flex: 3,
                child: Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                ...
                child: Container(
                  padding: const EdgeInsets.all(24),
                  child: SingleChildScrollView(child: _buildBasicInfo()),
                ),
              ),
              ...
              Expanded(
                ...
                child: Container(
                  padding: const EdgeInsets.all(24),
                  child: SingleChildScrollView(child: _buildDetailedInfo()),
                ),
              ),
            ],
          ),
