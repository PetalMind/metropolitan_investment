...
void main() {
  ...
  if (modalFile.existsSync()) {
    ...
    print('   ✅ Używa IntegratedClientService: ${usesIntegratedService ? "TAK" : "NIE"}');
    print('   ✅ Wywołuje getClientStats(): ${usesClientStats ? "TAK" : "NIE"}');  
    print('   ✅ Używa InvestorAnalyticsService: ${usesAnalyticsService ? "TAK" : "NIE"}');
    print('');
    
    if (!usesIntegratedService && !usesClientStats) {
      print('🎉 SUKCES: InvestorDetailsModal NIE używa IntegratedClientService');
      print('   Modal jest niezależny od naszych zmian w statystykach klientów');
      print('');
    } else {
  ...
  if (investorFile.existsSync()) {
    ...
    print('   ✅ Ma totalRemainingCapital: ${hasTotalRemainingCapital ? "TAK" : "NIE"}');
    print('   ✅ Ma totalInvestmentAmount: ${hasTotalInvestmentAmount ? "TAK" : "NIE"}');
    print('');
